      ...
      <table className="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="wd-total-activity">21:21:32</td>
          </tr>
          ...
          <tr>
            ...
            <td className="wd-login-id">012234561S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-11-11</td>
            <td className="wd-total-activity">00:21:32</td>
          </tr>
          ...
          <tr>
            ...
            <td className="wd-login-id">010234561S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2021-11-11</td>
            <td className="wd-total-activity">03:21:32</td>
          </tr>
        </tbody>
      </table>
    </div>
